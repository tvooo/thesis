...
text editors that are mainly used for programming. \citename{reynolds}
...
In his article, \citename{reynolds} makes a point against the use of
...
a limited understanding about the structure of code. \citename{lynch}
...
Thumbnails}, as presented by \citename{deline}, are implemented in
Sublime Text.
